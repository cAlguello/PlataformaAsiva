...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__entidades_authGuard__ = __webpack_require__("../../../../../src/app/entidades/authGuard.ts");
...
var appRoutes = [
    ...
    {
        path: 'perfil',
        canActivate: [__WEBPACK_IMPORTED_MODULE_6__entidades_authGuard__["a" /* authGuard */]],
        component: __WEBPACK_IMPORTED_MODULE_2__perfil_perfil_component__["a" /* PerfilComponent */]
    },
    {
        path: 'buscador',
        canActivate: [__WEBPACK_IMPORTED_MODULE_6__entidades_authGuard__["a" /* authGuard */]],
        component: __WEBPACK_IMPORTED_MODULE_3__buscador_buscador_component__["a" /* BuscadorComponent */]
    },
    //  { path: 'admin', component: AdminComponent }, temporalmente deshabilitado
    {
        path: 'producto',
        canActivate: [__WEBPACK_IMPORTED_MODULE_6__entidades_authGuard__["a" /* authGuard */]],
        component: __WEBPACK_IMPORTED_MODULE_5__producto_producto_component__["a" /* ProductoComponent */]
    },
    {
        path: 'consultas',
        canActivate: [__WEBPACK_IMPORTED_MODULE_6__entidades_authGuard__["a" /* authGuard */]],
        component: __WEBPACK_IMPORTED_MODULE_4__consultas_consultas_component__["a" /* ConsultasComponent */]
    },
    { path: '**', component: __WEBPACK_IMPORTED_MODULE_7__home_home_component__["a" /* HomeComponent */] }
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__entidades_authGuard__ = __webpack_require__("../../../../../src/app/entidades/authGuard.ts");
...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_12__app_routing_app_routing_module__["a" /* appRoutingProviders */], __WEBPACK_IMPORTED_MODULE_10__services_service__["a" /* ServicesService */], __WEBPACK_IMPORTED_MODULE_13__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_21__entidades_authGuard__["a" /* authGuard */]],
...
/***/ "../../../../../src/app/entidades/authGuard.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
module.exports = "<div class=\"container\">\n  <h2 class=\"center-align\">PLATAFORMA ASIVA</h2>\n  <div class=\"row\">\n    <div class=\"col s12 m6 l3 center-align\">\n      <div class=\"card\">\n        <div class=\"card-content\">\n          <i class=\"material-icons large\">poll</i>\n          <h5>EMPRESAS</h5>\n          <p>Actualmente contamos con  {{totalEmpresas}} empresas registradas</p>\n        </div>\n      </div>\n    </div>\n    <div class=\"col s12 m6 l3 center-align\">\n      <div class=\"card\">\n        <div class=\"card-content\">\n          <i class=\"material-icons large\">people_outline</i>\n          <h5>CONTACTOS</h5>\n          <p>Se han desarrollado {{totalContactos}} contactos dentro de nuestra plataforma</p>\n        </div>\n      </div>\n    </div>\n    <div class=\"col s12 m6 l3 center-align\">\n      <div class=\"card\">\n        <div class=\"card-content\">\n          <i class=\"material-icons large\">local_shipping</i>\n          <h5>PRODUCTOS Y SERVICIOS</h5>\n          <p>Las empresas registradas ofrecen mas de {{totalProductos}} productos y servicios</p>\n        </div>\n      </div>\n    </div>\n    <div class=\"col s12 m6 l3 center-align\">\n      <div class=\"card\">\n        <div class=\"card-content\">\n          <i class=\"material-icons large\">public</i>\n          <h5>RED</h5>\n          <p>Forma parte de nuestra red para buscar la información de nuestros socios y dar a conocer tu empresa</p>\n        </div>\n      </div>\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col s12 m4 offset-m4\">\n\n      <a (click)=\"irLogin()\" class=\"btn waves-effect waves-light col s12\">ACCEDER A LA PLATAFORMA</a>\n    </div>\n  </div>\n\n</div>"
...
var HomeComponent = (function () {
    function HomeComponent(router, service) {
        ...
        this.router = router;
        this.service = service;
        this.service.getTotalEmpresas().subscribe(function (val) {
            _this.totalEmpresas = val;
            console.log(val);
        });
        this.service.getTotalConsultas().subscribe(function (val) {
            _this.totalContactos = val;
            console.log(val);
        });
        this.service.contarProductos().subscribe(function (val) {
            _this.totalProductos = val;
        });
    }
    HomeComponent.prototype.ngOnInit = function () {
    };
    HomeComponent.prototype.irLogin = function () {
...
var PerfilComponent = (function () {
    ...
    PerfilComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getProductosUnicos(sessionStorage.getItem('id')).subscribe(function (val) {
            _this.productoServicioEmpresa = val;
    ...
    PerfilComponent.prototype.removeProducto = function (producto) {
        var _this = this;
        producto.id_empresa_producto = sessionStorage.getItem('id');
        console.log('PRODUCTO A REMOVER');
        console.log(producto);
        this.service.removeProductoEmpresa(producto).subscribe(function (val) {
            _this.service.getProductosUnicos(sessionStorage.getItem('id')).subscribe(function (val) {
                _this.ref.detectChanges();
                _this.productoServicioEmpresa = val;
                console.log('PRODUCTOS');
                console.log(val);
...
var ProductoComponent = (function () {
    ...
    ProductoComponent.prototype.addProducto = function (producto) {
        producto.id_empresa_producto = sessionStorage.getItem('id');
        console.log(producto);
        this.service.addProductoEmpresa(producto).subscribe(function (val) {
            console.log(val);
        }, function (error) {
            console.log(error);
        });
    };
    ProductoComponent.prototype.removeProducto = function (producto) {
        producto.id_empresa_producto = sessionStorage.getItem('id');
        console.log(producto);
        this.service.removeProductoEmpresa(producto).subscribe(function (val) {
        }, function (error) {
...
var ServicesService = (function () {
    ...
    //
    ServicesService.prototype.isAuthenticated = function () {
    ...
    ServicesService.prototype.contarProductos = function () {
    ...
    //ADMIN SERVICES
    ServicesService.prototype.getTotalEmpresas = function () {
        //console.log(this.host+'/authController/'+user)
        return this.http.get(this.host + '/dataEmpresaController/contarEmpresas')
            .map(function (res) { return res.json(); });
    };
    ServicesService.prototype.getTotalConsultas = function () {
        //console.log(this.host+'/authController/'+user)
    ...
    ServicesService.prototype.getProductosUnicos = function (id) {
        //console.log(this.host+'/authController/'+user)
    ...
    ServicesService.prototype.addProductoEmpresa = function (producto) {
        return this.httpClient.post(this.host + "/dataEmpresaController/addProductoEmpresa", producto, this.header);
    };
    ServicesService.prototype.removeProductoEmpresa = function (producto) {
